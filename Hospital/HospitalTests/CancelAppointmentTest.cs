...
namespace HospitalUnitTests
{
    public class CancelAppointmentTest
    {
        ...
        public static IEnumerable<object[]> ExistingData()
        {
            ...
            Appointment appointment = new Appointment(date, 30.00,
                date, room.id, room, patient.Id, patient, 1, doc, AppointmentType.Awaiting);
        ...
        public static IEnumerable<object[]> CancelledData()
        {
            ...
            Appointment appointment = new Appointment(date, 30.00,
                date, room.id, room, patient.Id, patient, 1, doc, AppointmentType.Cancelled);
